...
import { downloadFile, generateIdForDataSource, _get, _handleIdCard } from 'utils';
import { getTableMaxHeightRef } from 'utils/publicFunc';
...
export default function ExamList() {
  ...
  const columns = [
    ...
    { title: '预约日期', dataIndex: 'appointDate', width: 120 },
    { title: '约考日期', dataIndex: 'testDate', width: 120 },
    { title: '考试场地', dataIndex: 'testPlace', width: 80 },
    { title: '考试场次', dataIndex: 'testEtc', width: 80 },
    { title: '更新时间', dataIndex: 'insertTime', width: 140 },
  ];
