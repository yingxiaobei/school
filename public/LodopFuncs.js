  ...
  try {
    ...
    if (needCLodop() || isLinuxX86 || isLinuxARM) {
      ...
      if (!LODOP) {
        ...
        else if (CLODOP.CVERSION < '6.5.6.9') strAlertMessage = strCLodopUpdate;
    ...
    LODOP.SET_LICENSES('浙江维尔科技股份有限公司', 'F4140B07FAE17DEAE42758B87E83CAF4', '', '');
    //===如下空白位置适合调用统一功能(如注册语句、语言选择等):==
    LODOP.SET_LICENSES(
      '浙江维尔科技有限公司',
      '9F6318AE1CE56123F371162E393C53F6AE2',
      '浙江維爾科技有限公司',
      '4149465747E188953FCF4F857C0BF007CFE',
    );
    LODOP.SET_LICENSES(
      'THIRD LICENSE',
      '',
      'Zhejiang Weier Technology Co., Ltd',
      '50ED97788486BFFD132E404B650C2FE6F33',
    );
    //已购买按照公司名顶级注册
