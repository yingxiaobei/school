...
export async function _getExamList(query: { page: number; limit: number; testSubject?: string }) {
...
export async function _getSubjectList(query: { examTime?: string }) {
  return await request(`${EXAM_PREFIX}/v1/statistic/crawler/exam/subject`, 'GET', query);
}
...
export async function _exportExam(query: any) {
  return await request(`${EXAM_PREFIX}/v1/statistic/crawler/exam/export`, 'GET', query, {
